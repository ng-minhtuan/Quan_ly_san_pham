                    ...
                    <div class="card shadow border-0  mb-7">
                        <div class="card-body">
                            <div class="row card" style="align-content: center;">
                                <form class="form-signin row" action="{{route('list.updateImage',['id'=>$user->user_id])}}" method="POST" enctype="multipart/form-data" style="align-items: center;padding-top: 1rem; padding-bottom: 1.5rem">
