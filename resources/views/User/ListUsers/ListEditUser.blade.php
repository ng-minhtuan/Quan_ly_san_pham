...
@section('title')
    PROJECT - Sửa thông tin cá nhân của {{$user->fullname}}
@endsection

@section('body')

<div class="h-screen flex-grow-1 overflow-y-lg-auto">
    <header class="bg-surface-primary border-bottom pt-6" style="padding-bottom:1rem;">
    ...
    <main class="py-6 bg-surface-secondary" style="justify-content: center;">
        <div class="container-fluid">
            ...
            <div class = "row text-left">
                <form class="form-signin" action="{{ route('list.updateUser',['id'=>$user->user_id]) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group" style="margin-top:1rem;">
                        ...
                        @php
                            $a = date_create_from_format('d/m/Y',$user->birthdate);
                    ...
                    <div class="form-group" style = "display:flex;">
                        <div class="p-3 col-4">
                            ...
                            <img class="left-block d-block" src="{{Storage::url($user->image)}}" alt="{{$user->username}}">
