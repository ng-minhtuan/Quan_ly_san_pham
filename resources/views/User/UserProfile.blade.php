            ...
            <div class="mb-npx">
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 col-12 text-sm-end">
                        <div class="mx-n1">
                            <a href="{{route('user.getEdit')}}" class="btn d-inline-flex btn-sm btn-neutral border-base mx-1">
                                <span class=" pe-2"> <i class="bi bi-pencil"></i> </span>
                                <span>Sửa thông tin cá nhân</span>
                            </a>
                            <a href="" class="btn d-inline-flex btn-sm btn-danger border-base mx-1" onclick="event.preventDefault(); document.getElementById('delete-form-{{auth()->user()->user_id}}').submit();">
                                <span class=" pe-2"> <i class="bi bi-trash"></i></span>
                                <span>Xoá tài khoản</span>
                            </a>
                            <form id="delete-form-{{auth()->user()->user_id}}" action="{{route('user.delete')}}" method="POST" style="display: none;">
                                {{ csrf_field() }}
                            </form>
                        </div>
                            ...
                            <div class="row flex-direction-row card-body">
                                <div class="col-xl-4"  style="box-shadow: 1px 0 0 0  rgb(216, 216, 216); position: relative;padding-right: 2rem;">
                                    <div class="card-img" width="100%" height="100%">
                                        <img src="{{ Storage::url(auth()->user()->image)}}" class="img-radius" alt="User-Profile-Image" width="100%" height="100%">
                                    </div>
                                    <div style="width: 100%;
                                                text-align: center;
                                                margin-top: 1rem;">
                                        <a class="btn d-inline-flex btn-sm btn-outline-primary border-base mx-1" href="{{route('user.viewupdateimg')}}">
                                    ...
                                    <div class="row">
                                        <div class="row row-sm-2">
                                            <div class="card-body col-sm-2">
                                                ...
                                                <h6 class="text-muted f-w-400">{{auth()->user()->fullname}}</h6>
                                            </div>
                                            <div class="card-body col-sm-2">
                                        ...
                                        <div class="row row-sm-2">
                                            ...
                                            <div class="card-body col-sm-2">
                                                ...
                                                <hr style="margin:0.3rem 0 1rem 0;">
                                                <h6 class="text-muted f-w-400">{{auth()->user()->birthdate}}</h6>
                                            </div>
                                        </div>
                                        <div class="row row-sm-2">
                                            <div class="card-body col-sm-2">
                                        ...
                                        <div class="row row-sm-2">
                                            <div class="card-body col-sm-2">
                                                ...
                                                <h6 class="text-muted f-w-400" style="display: flex; align-items: center;">{{auth()->user()->tinTuc()->get()->count()}}</h6>
                                                <a href="{{route('list.tintuc',['id'=>auth()->user()->user_id])}}" class="btn btn-block" style="height: 2rem; color:rgb(0, 89, 255); padding: 0 1rem; align-items: center; display: flex; align-content: center;font-weight: normal; border: 1px solid rgba(45, 78, 66, 0.72);">
                                            ...
                                            <div class="card-body col-sm-2">
                                                ...
                                                <hr style="margin:0.3rem 0 1rem 0;">
                                                <h6 class="text-muted f-w-400">{{auth()->user()->updated_at}}</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
