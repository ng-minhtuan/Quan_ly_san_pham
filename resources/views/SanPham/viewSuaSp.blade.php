...
@section('title')
PROJECT - Sửa thông tin sản phẩm
@endsection
@section('body')
        ...
        <div class="container-fluid">
            <div class="card shadow border-0 mb-7">
                <div class="card-header row">
                    ...
                    <h2 class="mb-0 mt-1 col text-justify">Sửa thông tin sản phẩm</h2>
                </div>
                <div class="card-body">
                    <form class="form-text" data-action="{{route('sp.sua',['id'=>$sp->sp_id])}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row justify-content-md-center">
                            <div class="col">
                                <div class="form-group">
                                    <label style="font-weight: 700; color:#000; margin: 0.5rem 0;" for="lsp_ten">Tên sản phẩm</label>
                                    <input type="text" class="form-control" name="sp_ten" id="tieude" value="{{$sp->sp_ten}}">
                                    @error('sp_ten')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="sp_gia" id="tieude" placeholder="Hãy nhập vào giá của sản phẩm...." value= "{{$sp->sp_gia}}">
                                    @error('sp_gia')
                                        <span class="text-danger" role="alert">
                                            <p>{{ $message }}</p>
                                        </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="summary-ckeditor" name="sp_thongtin" style="height: 15rem;">{{$sp->sp_thongtin}}</textarea>
                                    @error('sp_thongtin')
                                        <span class="text-danger" role="alert">
                                            <p>{{ $message }}</p>
                                        </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="lsp" name="lsp" class="form-select form-select-sm" aria-label=".form-select-sm example" style="width:30%; display:inline-block;" value = "{{old('lsp')}}">
                                        ...
                                        @foreach($dslsp as $lsp)
                                            <option value="{{$lsp->lsp_ten}}" {{($lsp->lsp_id == $sp->lsp_id)? 'selected' : ''}}>{{$lsp->lsp_ten}}</option>
                                        @endforeach
                                    </select>
                                    @error('lsp')
                                        <span class="text-danger" role="alert">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="nsx" name="nsx" class="form-select form-select-sm" aria-label=".form-select-sm example" style="width:30%; display:inline-block;" value = "{{old('nsx')}}">
                                        ...
                                        @foreach($dsnsx as $nsx)
                                            ...
                                            <option {{($nsx->nsx_id == $sp->nsx_id)? 'selected' : ''}} value="{{$nsx->nsx_ten}}">{{$nsx->nsx_ten}}</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <label style="font-weight: 700; color:#000; margin: 1rem 0 0.5rem;" for="sp_hinhanh">Hình ảnh sản phẩm</label>
                        ...
                        <div class="card-footer">
                            <div class="form-group text-center">
                                <button type="submit" class="btn btn-success btn-sm">Sửa thông tin sản phẩm</button>
                            </div>
                        </div>
                    </form>
                </div>
