            ...
            <div class="mb-npx">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 col-12 text-sm-end" style="display: flex;justify-content: flex-end;">
                        <p class="pagination nav nav-tabs mt-4 overflow-x border-0">Hiện thị {{$ds->count()}} trong tổng số &nbsp; <b>{{\App\Models\TinTuc::get()->count()}}</b> &nbsp; tin tức hiện có</p>
                    </div>
            </div>
        </div>
                            ...
                            <div class="card-block px-6">
                                ...
                                <div class="row ">
                                    <p class="text-muted text-monospace text-sm-left">Người đăng :
                                        @php
                                        $user = \App\Models\User::find($tinTuc->user_id);
                                        echo $user->username;
                                        @endphp
                                    </p>
